...
HD_PWD='/home/pradeepjairam/ramanujamIP/other_rnd/fpga_demo_escalator/timer_DC/timer/synth/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_timer_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_timer_led.tcl
