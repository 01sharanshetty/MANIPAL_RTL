...
HD_PWD='/home/pradeepjairam/ramanujamIP/other_rnd/fpga_demo_escalator/escalator_fsm_4floor/esc_4floor_tb/esc_4floor_tb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_elev.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_elev.tcl -notrace
